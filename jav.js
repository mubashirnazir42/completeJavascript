...
//     case 'tuesday' : console.log('tues'); break;
//     case 'wednesday' : console.log('wed'); break;
//     case 'thirsday':
//         case 'friday' : console.log('off'); break;
//     default : console.log('hahah')
// }
...
switch('mub'){
    ...
    case 0 : console.log('hahaha'); break;
    case 1 : console.log('muahahha'); break;
    case 'mub' : console.log('tahahaha'); break;
    case 3 : console.log('wahahahhaa'); break;
    case 4 : console.log('thahahahahaha'); break;
